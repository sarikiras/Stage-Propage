...
path <- "/Users/sariakasalomon-ramialison/Downloads/all_data_propage20240201.xlsx"
...
Cette variable correspond en fait à la session d'observation. Pas de `NA`s. [Format string "XX.XXX" **Comment est-elle créée?**]
...
<img src="/Users/sariakasalomon-ramialison/Desktop/Screenshot 2024-02-07 at 22.03.51.png" alt="Localisation du `site_id`= 729" width="500">
...
Le `site_id`= 939 correspond certainement au `site_id`= 5. Il y a même quasi-correspondance de transect `id_releve`= et `id_releve`= **(Peut-on considérer que c'est le même?)**


<img src="/Users/sariakasalomon-ramialison/Desktop/Screenshot 2024-02-08 at 10.37.55.png" alt="Localisation du `site_id`= 5" width="500">
...
<img src="/Users/sariakasalomon-ramialison/Desktop/Screenshot 2024-02-08 at 10.56.51.png" alt="Localisation du `site_id`= 1484" width="500">

<img src="/Users/sariakasalomon-ramialison/Desktop/Screenshot 2024-02-08 at 11.01.09.png" alt="Localisation du `site_id`= 1484" width="500">


Petit table de correspondance nommée `data_sites` pour remplacer les valeurs manquantes.
...
##### 3.2 Sites sans coordonnées géographiques 
...
##### 3.3 Sites sans code postal - ni departement- (à faire pour avoir une jolie table complète...)



##### 3.4 Création de la spatial dataframe pour visualiser les cartes

Attention!

Dans la table : la variable `site_coordonnee` peut être soit un polygone, soit un point!


1. Création d'une spatial dataframe juste pour les sites
1. Création d'une spatial dataframe juste pour la gemometrie des sites 


### 2. Étude plus globale
<br>
